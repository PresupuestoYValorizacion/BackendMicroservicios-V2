...
internal sealed class GetRecursosByPartidaPaginationQueryHandler : IQueryHandler<GetRecursosByPartidaPaginationQuery, PagedResults<ClienteDto>?>
{
    ...
    public async Task<Result<PagedResults<ClienteDto>?>> Handle( GetRecursosByPartidaPaginationQuery request, CancellationToken cancellationToken)
    {
