...
public class LicenciaDbContext : DbContext, IUnitOfWorkTenant
{
    ...
    builder.Entity<EspecialidadTenant>()
        ...
        builder.Entity<RecursoTenant>().HasData(
            // Recursos Humanos
            RecursoTenant.Create("Cemento", 2127, 2125), 
            RecursoTenant.Create("Arena", 2128, 2125), 
            RecursoTenant.Create("Ladrillos", 2129, 2125), 
            RecursoTenant.Create("Clavos", 2130, 2125), 
            RecursoTenant.Create("Pintura", 2131, 2125), 
            RecursoTenant.Create("Tubería PVC", 2132, 2125), 
            RecursoTenant.Create("Obrero", 2133, 2126), 
            RecursoTenant.Create("Capataz", 2133, 2127),
            RecursoTenant.Create("Ayudante", 2133, 2127),
            RecursoTenant.Create("Ingeniero Residente", 2134, 2127)
        ...
        builder.Entity<PresupuestoTenant>()
            .HasOne(e => e.ProyectoTenant)
            .WithOne(e => e.Presupuesto)
            .HasForeignKey<ProyectoTenant>(presupuesto => presupuesto.PresupuestoId);
        ...
        builder.Entity<PresupuestoEspecialidadTituloTenant>()
            .HasOne(pEspTitulos => pEspTitulos.Especialidad)
            .WithMany(esp => esp.PresupuestosEspecialidadTitulos)
            .HasForeignKey(pEspTitulos => pEspTitulos.EspecialidadId);
