...
namespace MsAcceso.Infrastructure.Migrations.EnterpriseDb
{
    ...
    [Migration("20250120224906_initialApp")]
            ...
            modelBuilder.Entity("MsAcceso.Domain.Tenant.RecursosTenant.RecursoTenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d46b2fe-75ad-4f81-9354-64e1057afff1"),
                            Activo = true,
                            Nombre = "Cemento",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2127
                        ...
                        new
                        {
                            Id = new Guid("1d10c177-79c1-4901-9b7c-b43b3f90a1ad"),
                            Activo = true,
                            Nombre = "Arena",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2128
                        ...
                        new
                        {
                            Id = new Guid("a3138ec8-d562-41cd-85a8-7cc9cf064719"),
                            Activo = true,
                            Nombre = "Ladrillos",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2129
                        ...
                        new
                        {
                            Id = new Guid("4b08ed27-bf0a-408c-8c30-5ea1fa7ae308"),
                            Activo = true,
                            Nombre = "Clavos",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2130
                        ...
                        new
                        {
                            Id = new Guid("5d5bb9c6-b261-4b6b-bb50-763bc0d99253"),
                            Activo = true,
                            Nombre = "Pintura",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2131
                        ...
                        new
                        {
                            Id = new Guid("8f63095c-f4c4-469e-ba7e-53fd91f14546"),
                            Activo = true,
                            Nombre = "Tubería PVC",
                            TipoRecursoId = 2125,
                            UnidadMedidaId = 2132
                        ...
                        new
                        {
                            Id = new Guid("cdc786d0-a000-47d9-abcb-0243e1ee371c"),
                            Activo = true,
                            Nombre = "Obrero",
                            TipoRecursoId = 2126,
                            UnidadMedidaId = 2133
                        ...
                        new
                        {
                            Id = new Guid("d8e73375-b997-4118-b22c-b126ed63090e"),
                            Activo = true,
                            Nombre = "Capataz",
                            TipoRecursoId = 2127,
                            UnidadMedidaId = 2133
                        ...
                        new
                        {
                            Id = new Guid("81ef5a42-def1-4ff3-bdf9-f06930c5505f"),
                            Activo = true,
                            Nombre = "Ayudante",
                            TipoRecursoId = 2127,
                            UnidadMedidaId = 2133
                        ...
                        new
                        {
                            Id = new Guid("fc9c0c77-6339-4aab-bb75-68abaf7ca289"),
                            Activo = true,
